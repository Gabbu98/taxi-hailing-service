...
public class RideRepositoryIT {
    ...
    public RideRepositoryIT() {
        rider = new Rider("rider1", "Alice");
        driver = new Driver("1234","John", new Location(1,1));
    ...
    void testFindByStatus() {
        Ride ride1 = new Ride(rider, driver, pickup, dropoff);
        Ride ride2 = new Ride(rider, driver, pickup, dropoff);
